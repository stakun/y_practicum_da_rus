...
|:-|:-|:-|:-|:-|
|Музыка больших городов|Проверка гипотез о зависимости потребительского поведения пользователей Яндекс Музыки от дня недели, времени суток и города проживания|`Python`, `Pandas`|Интернет-сервисы, <br/>cтриминговые сервисы|Data Analyst|
